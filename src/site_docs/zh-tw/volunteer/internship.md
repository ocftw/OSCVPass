...
本頁為 OSCVPass 歷年實習夥伴的紀錄封存。目前計畫以志工形式招募夥伴，參與方式與職缺請見[志工招募](index.md)。

如果您對此專案有想法，也想參與貢獻成為志工，歡迎直接寄信到 <oscvpass@ocf.tw> 標題開頭註明 **[OSCVPass]** 內文包含簡單的自我介紹與您的想法，我們會儘快回覆，感謝！
...
因為我沒有學過前後端，所以多數時間都在學習相關知識，從基礎的 docker、poetry、git 的設定和 Mysql 的串聯到 flask 建立後端框架及熟悉 request、jinja、api 的使用
